...
/* SECURITY: In this implementation pathchirp_snd will be on
continuously and wait for pathchirp_rcv to initiate the connection.
In addition pathchirp_rcv acts as a master telling pathchirp_snd
at what rates to send packets etc. 

As the first step towards making pathchirp more secure we
